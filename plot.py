...
all_file_names = [["manual_logs/1000_test-1613762389.csv"],
                  ["manual_logs/long_test_old_shield-1614009995.csv"],
                  ["manual_logs/long_test_SIP_shield-1613967869.csv"]]
